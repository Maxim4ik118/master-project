...
var someLight2 = new _scripts_light__WEBPACK_IMPORTED_MODULE_2__["Light"](document.querySelector('body'), 'lime');
var someLight3 = new _scripts_light__WEBPACK_IMPORTED_MODULE_2__["Light"](document.querySelector('body'), 'turquoise');
var someLight4 = new _scripts_light__WEBPACK_IMPORTED_MODULE_2__["Light"](document.querySelector('body'), 'purple');
...
/* harmony import */ var _treafficLighter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./treafficLighter */ "./src/lesson_12/scripts/treafficLighter.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(LighterController, [{
    ...
    value: function addLighter() {
      var lighter = new _treafficLighter__WEBPACK_IMPORTED_MODULE_0__["TrafficLighterES6"](this.content);
    ...
    value: function renderLights() {
      ...
      try {
        var _loop = function _loop() {
          ...
          var light = new _light__WEBPACK_IMPORTED_MODULE_0__["Light"](_this3.lighter, color, function () {
            _this3.toggleOff();
